...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::shopee_tools::find_shopee_aff_id,
            commands::shopee_tools::clean_shopee_links,
            commands::ai_content::ai_validate_openai_key,
            commands::ai_content::ai_generate_fb_content,
